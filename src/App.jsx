      ...
      {/* LOGO */}
        ...
        <div className="mt-6 flex flex-col gap-6 inputs w-full ">
            <div >
              ...
              <input className=' p-4 mt-2 w-full h-14 border border-black-900 rounded-md ' type="text"  placeholder='Your email address'/>
            </div>
            <div >
              <p className='text-gray-800 text-sm'>Password</p>
              <input className=' p-4 mt-2 w-full h-14 border border-black-900 rounded-md ' type="text"  placeholder='Your Password'/>
            </div>
            <button className='w-full h-14 bg-black text-white border rounded-md'>Log In</button>
