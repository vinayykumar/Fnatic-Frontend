    ...
    <div className='flex flex-col gap-8 w-full h-screen'>
      ...
      <div className='flex flex-col w-full h-full'>
          <div className='w-full h-full'>
            <div className='flex h-full pl-16 pr-16 gap-4'>
          ...
          <div className='flex flex-col items-center w-full'>
            ...
            <p className='text-center w-96'>Esports gear is about simplicity, comfort and reliability - it's exactly what you need to perform and nothing else</p>
            <button className=' w-36 h-12 bg-black text-white rounded-lg p-2 text-sm'>See Fnatic Gear</button>
          </div>
      </div>
