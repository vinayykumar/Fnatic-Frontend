...
const Navbar = () => {
  return (
      <div className='mt-4 flex w-full h-16 bg-white p-3 lg:p-8'>
        <div className='flex w-full justify-between items-center bottom-b-1'>
            ...
            <div className="right flex flex-row items-center gap-5">
                ...
                <div className='flex items-center justify-center hidden lg:block w-20 h-10 p-2 border border-gray-300 rounded rounded-md'>
                    <p className='text-center'>Log In</p>
                </div>
                <div className='flex items-center justify-center hidden lg:block w-20 h-10 p-2 bg-black rounded rounded-md'>
